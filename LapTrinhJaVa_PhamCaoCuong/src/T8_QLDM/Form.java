...
public class Form extends javax.swing.JFrame {
    ...
    public DanhMuc KhoiTao() {
        ...
        lh.setMaSach(txtMaSach.getText());
        lh.setTenSach(txtTenSach.getText());
        lh.setGiaBia(Double.parseDouble(txtGiaBia.getText()));
        return lh;
    }
    ...
    public void HienThi(DanhMuc LH) {
        Model.addRow(new Object[]{
            LH.getMaSach(), LH.getTenSach(), LH.getGiaBia()
        });
    }
    /*Xóa*/
    public void Xoa() {
    ...
    public void Sua(DanhMuc LH) {
        for (int i = 0; i < DanhMuc.size(); i++) {
            if (DanhMuc.get(i).getMaSach() == txtMaSach.getText()) {
                a = i;
            }
        }
        DanhMuc lh = KhoiTao();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtTenSach, javax.swing.GroupLayout.PREFERRED_SIZE, 391, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jtbQLDLHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbQLDLHMouseClicked
        ...
        txtMaSach.setText(mD.getValueAt(index, 0).toString());
        txtTenSach.setText(mD.getValueAt(index, 1).toString());
        txtGiaBia.setText(mD.getValueAt(index, 2).toString());
