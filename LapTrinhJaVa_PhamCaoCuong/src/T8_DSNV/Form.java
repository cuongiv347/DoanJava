...
public class Form extends javax.swing.JFrame {
    ...
    public NhanVien KhoiTao() {
        ...
        lh.setMaNV(txtMaNV.getText());
        lh.setTenNV(txtTenNV.getText());
        lh.setNgaySinh(Double.parseDouble(txtNgaySinh.getText()));
        return lh;
    }
    ...
    public void HienThi(NhanVien LH) {
        Model.addRow(new Object[]{
            LH.getMaNV(), LH.getTenNV(), LH.getNgaySinh()
        });
    }
    /*Xóa*/
    public void Xoa() {
    ...
    /*Sửa*/
    public void Sua(NhanVien LH) {
        for (int i = 0; i < NhanVien.size(); i++) {
            if (NhanVien.get(i).getMaNV() == txtMaNV.getText()) {
                a = i;
            }
        }
        NhanVien lh = KhoiTao();
    ...
    private void initComponents() {
        ...
        jtbQLDLH.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Nhân Viên :", "Họ Tên Nhân Viên", "Ngày Sinh"
            }
        ));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtTenNV, javax.swing.GroupLayout.PREFERRED_SIZE, 391, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jtbQLDLHMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbQLDLHMouseClicked
        ...
        txtMaNV.setText(mD.getValueAt(index, 0).toString());
        txtTenNV.setText(mD.getValueAt(index, 1).toString());
